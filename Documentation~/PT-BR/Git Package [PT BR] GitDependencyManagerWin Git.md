# Git Package [PT BR] GitDependencyManagerWin Git
## Campos&Propriedades
```c#
...
```
## GetAllRepos()
Metódo que inicia o processo de coletar os repositórios vulgo dependências pendentes.
```c#
...
Verifica se o repositório está presente no diretório `/GitTemp`.
```c#
